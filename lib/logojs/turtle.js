...
(function(global) {
  ...
  function CanvasTurtle(canvas_ctx, turtle_ctx, w, h, events, options) {
  ...
  Object.defineProperties(CanvasTurtle.prototype, {
    ...
    _tick: {value: function() {
      ...
      if (this.visible) {
        ...
        if (!this.options.customTurtleGraphics){
            ctx.beginPath();
            ...
            var customTurtle = this.options.customTurtleGraphics;
            var turtleSize = this.options.customTurtleSize || 40;
            ctx.drawImage(customTurtle, 0, 0, customTurtle.width, customTurtle.height,
                -turtleSize/2, -turtleSize/2, turtleSize, turtleSize);
        }
