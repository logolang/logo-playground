...
const allTurtles: TurtleInfo[] = [
    {
        name: 'Bright Runner',
        imageData: require('../ui/images/turtles/tt12.svg') as string
    },
    {
        name: 'Princess',
        imageData: require('../ui/images/turtles/tt9.svg') as string
    },
    {
        name: 'Chilly Bob',
        imageData: require('../ui/images/turtles/tt10.svg') as string
    },
    {
        name: 'Summer',
        imageData: require('../ui/images/turtles/tt11.svg') as string
    },
    {
        name: 'Deep Diver',
        imageData: require('../ui/images/turtles/tt13.svg') as string
    }
]
